...
if has("gui_running")
    ...
    if ! g:inkpot_black_background
        exec "hi Normal         cterm=NONE   ctermfg=" . <SID>X(87) . " ctermbg=" . <SID>X(80)
    else
    ...
    exec "hi Comment        cterm=NONE   ctermfg=" . <SID>X(37) . " ctermbg=" . "NONE"
    exec "hi Constant       cterm=NONE   ctermfg=" . <SID>X(73) . " ctermbg=" . "NONE"
    exec "hi String         cterm=NONE   ctermfg=" . <SID>X(72) . " ctermbg=" . <SID>X(80)
    exec "hi Error          cterm=NONE   ctermfg=" . <SID>X(79) . " ctermbg=" . <SID>X(32)
    exec "hi Identifier     cterm=NONE   ctermfg=" . <SID>X(27) . " ctermbg=" . "NONE"
    exec "hi Ignore         cterm=NONE"
    exec "hi Number         cterm=NONE   ctermfg=" . <SID>X(52) . " ctermbg=" . "NONE"
    exec "hi PreProc        cterm=NONE   ctermfg=" . <SID>X(25) . " ctermbg=" . "NONE"
    exec "hi Special        cterm=NONE   ctermfg=" . <SID>X(55) . " ctermbg=" . "NONE"
    exec "hi SpecialChar    cterm=NONE   ctermfg=" . <SID>X(55) . " ctermbg=" . <SID>X(80)
    exec "hi Statement      cterm=BOLD   ctermfg=" . <SID>X(15) . " ctermbg=" . "NONE"
    exec "hi Todo           cterm=BOLD   ctermfg=" . <SID>X(16) . " ctermbg=" . <SID>X(57)
    exec "hi Type           cterm=BOLD   ctermfg=" . <SID>X(25) . " ctermbg=" . "NONE"
    ...
    if v:version >= 700
        ...
        exec "hi MatchParen     cterm=NONE ctermbg=" . <SID>X(37) . "ctermfg=" . <SID>X(25)
    endif
    if v:version >= 703
